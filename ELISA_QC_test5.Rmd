...
layout <- read.csv(file.path(data_path,"layout_wells_test5_051325.csv"), 
...
results <- read.csv(file.path(data_path,"myassays_table_test5_051325.csv"), 
                    stringsAsFactors = TRUE, 
                    na.strings = c("", " ", "-"))
