...
ggplot(exp, aes(x = Sample_num, 
  ...
  geom_smooth(method = "lm", se = TRUE, linewidth = 0.4, alpha = 0.2) +
 # geom_smooth(formula = y ~ log(x), se = FALSE, linewidth = 0.3, linetype = 2, alpha = 0.2) +
...
#df$Dilution_sample <- as.factor(df$Dilution_sample)
...
expected_vals <- tibble(
  Sample = c("STD1", "STD2", "STD3", "STD4", "STD5"),
  Expected_pg.mg = c(3200, 1600, 800, 400, 200)  # replace with your known expected values
)
