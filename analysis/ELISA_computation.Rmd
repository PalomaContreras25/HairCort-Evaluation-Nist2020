...
rmse06 <- sqrt(mean(residuals06^2))   
...
# Root Mean Squared Error
rmse25 <- sqrt(mean(residuals25^2))       
# Standard Deviation of Residuals
...
cat("Root Mean Squared Error (RMSE) 0.06 mL:", round(rmse06, 3), "\n")
cat("Standard Deviation of Residuals 0.06 mL:", round(std_dev06, 3), "\n")
```
## buffer = 0.25 mL
```{r echo = FALSE}
cat("Mean Absolute Error (MAE) 0.25 mL:", round(mae25, 3), "\n")
cat("Root Mean Squared Error (RMSE) 0.25 mL:", round(rmse25, 3), "\n")
