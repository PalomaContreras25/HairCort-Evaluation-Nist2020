...
Here I use results from ELISA test-3. All hair samples were obtained from the same person. I tested 3 variables:
...
# Scatter plot of Binding Percentage vs Weight, 2 groups (by dilution)
...
ggplot(data, aes(x = Weight_mg, 
  ...
  geom_hline(yintercept = 50, linetype = "dashed", 
             color = "gray", linewidth = 1) +  # Add horizontal line 
  labs(title = "Binding Percentage vs Weight, 2 groups (by dilution)",
...
## Comparitng models using Akakike's information criteria 
