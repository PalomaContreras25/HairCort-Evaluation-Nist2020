...
ggplot(a, aes(x = Sample_num, 
  ...
  geom_smooth(method = "lm", formula = y ~ poly(x, 3), se = TRUE, linewidth = 0.5, alpha = 0.2) +
  geom_point(size = 2) +
...
ggplot(exp, aes(x = Sample_num, 
                 y = Binding.Perc, color = Category)) +
  geom_smooth(method = "lm", formula = y ~ poly(x, 1), se = TRUE, linewidth = 0.5, alpha = 0.2) +
  geom_point(size = 2) +
  geom_text(aes(label = Sample), size = 3, vjust = -1, hjust = 0.5, color = "gray30") +
  geom_hline(yintercept = 80, linetype = "dashed", 
             color = "gray", linewidth = 1) +  
...
ggplot(a, aes(x = Exp, 
  ...
  geom_smooth(method = "lm", se = TRUE, linewidth = 0.5, alpha = 0.06) +
  geom_point(size = 2) +
...
ggplot(a, aes(x = (Exp), 
                 y = (Ave_Conc_pg.ml))) +
  geom_smooth(method = "lm", se = TRUE, linewidth = 0.5, alpha = 0.05, color = "salmon") +
