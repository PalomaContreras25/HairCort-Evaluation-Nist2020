...
data1 <- data[,c("Sample","Wells", "Category", "Binding.Perc", "Ave_Conc_pg.ml", "Weight_mg", "Buffer_nl", "Spike")]
...
ggplot(data_std, aes(x = Weight_mg, 
                 y = Binding.Perc, 
                 color = Category)) +
  geom_point(size = 3) +
    ...
    geom_hline(yintercept = 80, linetype = "dashed", 
             color = "gray", linewidth = 1) + 
  labs(title = "Results separated by weight",
